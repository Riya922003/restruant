...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-6 py-12">
      <div className="w-full max-w-4xl overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm md:grid md:grid-cols-2">
        <section className="hidden flex-col justify-between bg-zinc-950 p-8 text-white md:flex">
          <div>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-zinc-300 px-3 py-2 text-sm text-zinc-950 outline-none focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900"
                value={email}
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              {TEST_ACCOUNTS.map((account) => (
                <button
                  ...
                  className="rounded-md border border-zinc-300 px-3 py-2 text-left text-sm text-zinc-800 transition hover:border-zinc-900 hover:bg-zinc-50 disabled:opacity-60"
                >
                  {account.label}
                </button>
              ))}
